\doxysection{numpy.\+doc.\+basics Namespace Reference}
\hypertarget{namespacenumpy_1_1doc_1_1basics}{}\label{namespacenumpy_1_1doc_1_1basics}\index{numpy.doc.basics@{numpy.doc.basics}}
...
``1 + np.finfo(np.longdouble).eps``.\end{DoxyVerb}
